...
```
PAINEL_JWT_SECRET=(copie do arquivo .env.local)
PAINEL_SENHA_PATRICIA=(copie do arquivo .env.local)
PAINEL_SENHA_JULIO=(copie do arquivo .env.local)
HUGGINGFACE_API_TOKEN=(copie do arquivo .env.local)
```
...
2. Adicione: `HUGGINGFACE_API_TOKEN` = (copie do arquivo .env.local)
